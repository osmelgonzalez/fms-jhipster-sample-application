...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './camp.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAMP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CAMP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CAMP actions', async () => {
      const arg = { id: 24286 };
    ...
    it('dispatches UPDATE_CAMP actions', async () => {
      const arg = { id: 24286 };
    ...
    it('dispatches PARTIAL_UPDATE_CAMP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CAMP actions', async () => {
      const arg = 42666;
