...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './file-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILEDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FILEDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FILEDATA actions', async () => {
      const arg = { id: 2412 };
    ...
    it('dispatches UPDATE_FILEDATA actions', async () => {
      const arg = { id: 2412 };
    ...
    it('dispatches PARTIAL_UPDATE_FILEDATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FILEDATA actions', async () => {
      const arg = 42666;
