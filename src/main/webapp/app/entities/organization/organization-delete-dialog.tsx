...
import { deleteEntity, getEntity } from './organization.reducer';
...
export const OrganizationDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/organization${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myApp.organization.delete.question">Are you sure you want to delete Organization {organizationEntity.id}?</ModalBody>
      <ModalFooter>
