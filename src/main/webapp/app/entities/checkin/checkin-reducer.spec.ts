...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './checkin.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHECKIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHECKIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHECKIN actions', async () => {
      const arg = { id: 20452 };
    ...
    it('dispatches UPDATE_CHECKIN actions', async () => {
      const arg = { id: 20452 };
    ...
    it('dispatches PARTIAL_UPDATE_CHECKIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHECKIN actions', async () => {
      const arg = 42666;
