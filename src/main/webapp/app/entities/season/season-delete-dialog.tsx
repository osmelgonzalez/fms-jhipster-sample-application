...
import { deleteEntity, getEntity } from './season.reducer';
...
export const SeasonDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/season${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myApp.season.delete.question">Are you sure you want to delete Season {seasonEntity.id}?</ModalBody>
      <ModalFooter>
