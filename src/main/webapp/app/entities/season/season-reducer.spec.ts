...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './season.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEASON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SEASON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SEASON actions', async () => {
      const arg = { id: 679 };
    ...
    it('dispatches UPDATE_SEASON actions', async () => {
      const arg = { id: 679 };
    ...
    it('dispatches PARTIAL_UPDATE_SEASON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SEASON actions', async () => {
      const arg = 42666;
