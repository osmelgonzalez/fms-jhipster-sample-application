...
export const Player = () => {
  ...
  return (
    <div>
            ...
            <tbody>
              {playerList.map((player, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{player.middleInitial}</td>
                  <td>{player.lastName}</td>
                  <td>{player.gender}</td>
                  <td>
                    {player.dateOfBirth ? <TextFormat type="date" value={player.dateOfBirth} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/player/${player.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/player/${player.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
      ...
      {totalItems ? (
        <div className={playerList && playerList.length > 0 ? '' : 'd-none'}>
