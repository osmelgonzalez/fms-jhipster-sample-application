...
import { deleteEntity, getEntity } from './player.reducer';
...
export const PlayerDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/player${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myApp.player.delete.question">Are you sure you want to delete Player {playerEntity.id}?</ModalBody>
      <ModalFooter>
