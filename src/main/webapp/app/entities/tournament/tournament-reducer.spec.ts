...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOURNAMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TOURNAMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TOURNAMENT actions', async () => {
      const arg = { id: 3101 };
    ...
    it('dispatches UPDATE_TOURNAMENT actions', async () => {
      const arg = { id: 3101 };
    ...
    it('dispatches PARTIAL_UPDATE_TOURNAMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TOURNAMENT actions', async () => {
      const arg = 42666;
