...
import { deleteEntity, getEntity } from './tournament.reducer';
...
export const TournamentDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/tournament${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myApp.tournament.delete.question">Are you sure you want to delete Tournament {tournamentEntity.id}?</ModalBody>
      <ModalFooter>
