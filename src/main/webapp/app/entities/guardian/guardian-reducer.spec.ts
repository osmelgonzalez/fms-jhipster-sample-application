...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './guardian.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GUARDIAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GUARDIAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GUARDIAN actions', async () => {
      const arg = { id: 10278 };
    ...
    it('dispatches UPDATE_GUARDIAN actions', async () => {
      const arg = { id: 10278 };
    ...
    it('dispatches PARTIAL_UPDATE_GUARDIAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GUARDIAN actions', async () => {
      const arg = 42666;
